---
title: Playground
description: Explore graphraum node and edge visuals live, then run the timed proof protocol in this browser.
template: splash
...
<div class="proof-intro">
  <p class="proof-kicker">Executable playground</p>
  <h1>Try the visuals. Then prove the cadence.</h1>
  <p class="proof-lede">Explore shapes, strokes, aspect, and edge styles on a live graph in this browser. Switch to Prove when you need the deterministic timing protocol. No uploaded traces. No favorable-machine screenshot.</p>
</div>
...
Use the Explore tab to rematerialize a typed fixture with the GPU shape catalog, stroke, free aspect, edge width/opacity, dash styles, and markers. Pan, zoom, and select while you change controls. This tab is for visual verification, not a published score.
